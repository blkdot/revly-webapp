          ...
          case 'accrued_ads':
            return (
              <div>
                ...
                <span className='widget__value-profit'>/AED {parseFloat(metricsbeforePeriod.all?.profit.toFixed(1)).toLocaleString('en-US')}</span>
              </div>
            );
          case 'roas':
            return (
          ...
          >
            <div>
              ...
              {loading ? (
                ...
                <TypographyKit
                  variant='h3'
                  className={`card-typography ${(link === 'roi' || link === 'roas' || link === 'accrued_ads') && 'card-roi'}`}
                >
                  {renderMetrics()}
                </TypographyKit>
              )}
