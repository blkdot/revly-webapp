...
const OfferDetailComponent = () => {
  ...
  const menu_items = [
    {
      drn_id: '8f6312b8-2a0f-4fe8-97c7-8a7c4cc8478d',
      id: 391328279,
    },
    {
      drn_id: '8f6312b8-2a0f-4fe8-97c7-8a7c4cc8478',
      id: 391328279,
    },
    {
      drn_id: '8f6312b8-2a0f-4fe8-97c7-8a7c4cc84d',
      id: 391328279,
    },
  ];
          ...
          {status !== 'Scheduled' && (
            <div className="offer-visibility-container">
              ...
              <div className="offer-visibility-block">
                ...
                <div className="offer-visibility-sub-title">{offerData?.average_basket}</div>
              </div>
              <div className="offer-visibility-block">
                <div>
