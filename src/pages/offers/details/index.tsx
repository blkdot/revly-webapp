    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {data.start_hour ? format(new Date(`01 Jan 1970 ${data.start_hour || '00:00'}:00`), 'H:mm aaa') : <SkeletonKit />}
          </span>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            {data.end_hour ? format(new Date(`01 Jan 1970 ${data.end_hour || '00:00'}:00`), 'H:mm aaa') : <SkeletonKit />}
          </span>
        </div>
      </div>
    </div>
