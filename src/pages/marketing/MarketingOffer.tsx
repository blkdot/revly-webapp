...
const MarketingOffer = () => {
  ...
  const headersPerformance = [
    ...
    { id: 'max_discount', disablePadding: true, label: 'Discounts', tooltip: 'Total amount of discounts given for this offer' },
    { id: 'profit', disablePadding: true, label: 'Profits', tooltip: 'Revenue generated by the offer minus aggregator$apos;s commission, discounts amount, ads CPC and food cost.' },
    ...
    {
      id: 'roi', disablePadding: true, label: 'ROI', tooltip: '# AED generated in Profits for every 1 AED spent on discount. Profits are revenue minus aggregator&apos;s commission, order discount, ads CPC and food cost.' },
    { id: 'status', disablePadding: true, label: 'Status' },
  ];
  ...
  useEffect(() => {
    ...
    setOffersDataFiltered(filteredData.map((obj) => ({
      ...obj, start_end_date: {
  ...
  return (
    <div className='wrapper marketing-wrapper'>
      ...
      {openedOffer ? <OfferDetailComponent
