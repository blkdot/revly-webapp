...
const MarketingAds = () => {
  ...
  const headersManagment = [
    ...
    { id: 'spend', disablePadding: true, label: 'Budget spent - total', tooltip: 'Used budget compared to the defined budget' },
  ...
  const headersPerformance = [
    ...
    { id: 'vendor_ids', disablePadding: true, label: 'Branches' },
    { id: 'spend', disablePadding: true, label: 'Budget spent - total', tooltip: 'Used budget compared to the defined budget' },
    { id: 'revenue', disablePadding: true, label: 'Revenue', tooltip: 'Revenue generated by the offer' },
    { id: 'orders', disablePadding: true, label: 'Orders', tooltip: '# of orders generated by the offer' },
    { id: 'clicks', disablePadding: true, label: 'Clicks', tooltip: '# of customers who viewed your menu' },
    { id: 'impressions', disablePadding: true, label: 'Impressions', tooltip: '# of users who viewed your restaurant (branch) on the application' },
    { id: 'conversion_rate', disablePadding: true, label: 'Conversion rate', tooltip: '# of customers who placed an order out of # of customers who viewed your menu' },
    { id: 'return_on_ad_spent', disablePadding: true, label: 'Return on ad ', tooltip: 'Return on Ad Spent (RoAD), # AED generated in Revenue for every 1 AED spent on Ads.' },
    { id: 'customers', disablePadding: true, label: 'New customers', tooltip: 'New customers attracted by the campaign' },
    { id: 'status', disablePadding: true, label: 'Status' },
  ];
  ...
  useEffect(() => {
    ...
    setAdsFilteredData(filteredData.map((obj) => ({
      ...obj, start_end_date: {
      ...
      spend: obj.spend === null || obj.total_budget === null ? null : `${obj.spend}/${obj.total_budget}`  
    })));
